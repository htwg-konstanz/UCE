...
public class HandleMessage implements Runnable {
    ...
    // LoggerFactory.getLogger(HandleMessage.class);
    //
    // /**
    // * @param datagramPacket message datagram
    // * @param datagramSocket response socket
    // */
    // public HandleMessage(DatagramPacket datagramPacket, DatagramSocket
    // datagramSocket) {
    ...
    // uceRequestMessage.getTransactionId());
    //
    // if (uceRequestMessage.isMethod(CommonUceMethod.CONNECTION_REQUEST))
    // connectionRequest();
    // else if (uceRequestMessage.isMethod(CommonUceMethod.REGISTER))
    // register();
    ...
    // uceRequestMessage.getMethod().toString());
    ...
    // * Possible results:
    // * - multiple messages with 1..9 users and fragmentation flag / seq
    // numbers
    // * - send over tcp
    // *
    ...
    // sendErrorResponse(uceRequestMessage, 0,
    // "SocketEndpoint attribute Expected");
    ...
    // uceRequestMessage.getAttribute(SocketEndpoint.class);
    // UniqueUserName uniqueUserName =
    // uceRequestMessage.getAttribute(UniqueUserName.class);
    ...
    // InetSocketAddress newEndpoint = new InetSocketAddress(sourceAddress,
    // tcpSourcePort);
    // SocketEndpoint newSocketEndpoint = new SocketEndpoint(newEndpoint,
    // endpointClass);
    //
    ...
    //
    // logger.info("send successResponse and tcp address {}:{} to target",
    // sourceAddress, tcpSourcePort);
    // datagramSocket.send(datagramPacket);
    // }
    //
    // /**
    ...
    // *
    // * If source address changes it is updated in the DB alongside the
    // timestamp.
