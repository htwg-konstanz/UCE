...
/**
 * Listener Class. Listens on UPD-Socket for incoming messages. These messages
 * get interpreted in the HandleMessage class.
 * 
...
public class ListenerThread extends Thread {
    ...
    // LoggerFactory.getLogger(ListenerThread.class);
    //
    // /**
    ...
    // HandleMessage handleMessage = new HandleMessage(datagramPacket,
    // datagramSocket);
